...
public class AdminController {
	...
	@Autowired private TicketStatusRepository ticketStatusRepository;
	@Autowired private TicketPriorityRepository ticketPriorityRepository;
	...
	public String dashboard(Model model) {
		...
		model.addAttribute("techniciansCount", userService.countUsersByRoleName("Technicien"));
		...
		// On sépare les clés (labels) et les valeurs (données) en deux listes distinctes
	...
	public String listUsers(@RequestParam(name = "userType", required = false) Integer userType,
		...
		model.addAttribute("technicians", userService.countUsersByRoleName("Technicien")); // ou "TECH" selon ta DB
